...
func init() {
	Values["time"] = map[string]reflect.Value{
		...
		"DateOnly": reflect.ValueOf(time.DateOnly),
		"DateTime": reflect.ValueOf(time.DateTime),
		...
		"Layout": reflect.ValueOf(time.Layout),
		...
		"TimeOnly": reflect.ValueOf(time.TimeOnly),
