...
func init() {
	Values["go/ast"] = map[string]reflect.Value{
		...
		"ParseDirective": reflect.ValueOf(ast.ParseDirective),
		...
		"Directive": reflect.ValueOf((*ast.Directive)(nil)),
		"DirectiveArg": reflect.ValueOf((*ast.DirectiveArg)(nil)),
